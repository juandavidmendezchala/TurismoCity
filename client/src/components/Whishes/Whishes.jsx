      ...
      <>
        ...
        <div className={style.cajaform}>
          <form id="form">
            ...
            <div className={style.botonWhishes}><button onClick={handleSubmit}>Listar y guardar deseo</button></div>
            <div className={style.botonWhishes}><button onClick={handleSubmitList}>Listar solamente</button></div>
