...
import {
  ...
  getActivityNoDest,
  whishAdd,
} from "../../store/actions/actionsWhishes";
        ...
        <div className={style.cajaform}>
          <form id="form">
            ...
            <div>
              ...
              ></input>
              {errors.presupuesto && (
                <p className={style.danger}>{errors.presupuesto}</p>
              )}
            </div>
            <div>
              <label>Notas</label>
...
function mapStateToProps(state) {
  return {
    arraydeseos: state.whishes.whishes
  }
}

function mapDispacthToProps(dispatch) {
  return {
    getActivityAll: (elem1, elem2, elem3, elem4, elem5) =>
      dispatch(getActivityAll(elem1, elem2, elem3, elem4, elem5)),
    getActivityNoDest: (elem1, elem2, elem3, elem4) =>
      dispatch(getActivityNoDest(elem1, elem2, elem3, elem4)),
    whishAdd: (elem1) => dispatch(whishAdd(elem1)),
  };
}

export default connect(mapStateToProps, mapDispacthToProps)(Whishes);
