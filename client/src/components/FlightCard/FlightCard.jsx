...
function FlightCard(props) {
    ...
    return (
        <div className='conteinerAllCard'>
            ...
            {props.flights?.length === 0 && props.way === 'roundtrip' ? (<div className='alert'>Se excedió el tiempo de busqueda o no hay vuelos que coincidan con esta búsqueda.<br /> Por favor, inténtalo nuevamente haciendo click aquí: <br /><br /><br /><a className='refresh' href={`/flights?way=${props.way}&fromPlace=${props.fromPlace}&toPlace=${props.toPlace}&fromDate=${props.fromDate}&toDate=${props.toDate}&classFlight=${props.classFlight}&adults=${props.adults}&kids=${props.kids}&babies=${props.babies}&currency=${props.currency}`}>&#128257;</a></div>) : null}
            {props.flights?.length === 0 && props.way === 'onewaytrip' ? (<div className='alert'>Se excedió el tiempo de busqueda o no hay vuelos que coincidan con esta búsqueda.<br /> Por favor, inténtalo nuevamente haciendo click aquí: <br /><br /><br /><a className='refresh' href={`/flights?way=${props.way}&fromPlace=${props.fromPlace}&toPlace=${props.toPlace}&fromDate=${props.fromDate}&classFlight=${props.classFlight}&adults=${props.adults}&kids=${props.kids}&babies=${props.babies}&currency=${props.currency}`}>&#128257;</a></div>) : null}
