...
const Politics = () => {
    return (
        <div>
            ...
            <p>El presente Política de Privacidad establece los términos en que LowHenry usa y protege la información que es
            ...
            <p>Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, particularmente para
                ...
                cualquier momento.</p>
            <p>LowHenry está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los
            ...
            <p>LowHenry Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.
            </p>
        </div>
    )
}
